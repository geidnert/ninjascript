...
namespace NinjaTrader.NinjaScript.Strategies.AutoEdge
{
    public class DuoTesing : Strategy
    {
        ...
        [Range(1, int.MaxValue)]
        public int London_SwingStrength { get; set; }
        ...
        public int London_SwingDrawBars { get; set; }
        ...
        [Range(0, int.MaxValue)]
        public int London_SwingSweepLookbackBars { get; set; }
        ...
        public bool London_UseSwingFilter { get; set; }
        ...
        [Range(1, int.MaxValue)]
        public int NewYork_SwingStrength { get; set; }
        ...
        [Range(0, int.MaxValue)]
        public int NewYork_SwingDrawBars { get; set; }
        ...
        [Range(0, int.MaxValue)]
        public int NewYork_SwingSweepLookbackBars { get; set; }
        ...
        public bool NewYork_UseSwingFilter { get; set; }
        ...
        private void AddSwingLine(bool isHigh, int barsAgo, double price)
        {
            ...
            string tag = string.Format("DuoTesting_Swing_{0}_{1}", isHigh ? "H" : "L", startBarIndex);
