...
{
    public class AURATesting : Strategy
    {
        #region Enums
        ...
        private const string HeartbeatStrategyName = "AURATesting";
...
2026-12-31,08:30";
        ...
        private AURATestingProjectXOrderRouter projectXRouter;
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description  = "AURATesting MGC 3m WFA Fold9 - IS Jul2025-Jun2026 IS net=$61428 DD=$775 trades=1996. Deploy Jul-Aug 2026.";
                Name         = "AURATesting";
        ...
        {
            projectXRouter = new AURATestingProjectXOrderRouter(
                () => ProjectXApiBaseUrl,
                () => ProjectXUsername,
                () => ProjectXApiKey,
                () => ProjectXAccountId,
        ...
        private List<Tuple<string, string, Brush, Brush>> BuildInfoLines()
        {
            ...
            lines.Add(InfoLine(string.Format("AURATesting v{0}", GetAddOnVersion()), string.Empty, InfoHeaderTextBrush, Brushes.Transparent));
        ...
        [NinjaScriptProperty][Display(Name="ProjectX API Base URL",Description="ProjectX gateway base URL.",Order=4,GroupName="12. Webhooks")] public string ProjectXApiBaseUrl {get;set;}
        [NinjaScriptProperty][Display(Name="ProjectX Trade All Accounts",Description="If enabled, route ProjectX orders to every tradable account returned by ProjectX.",Order=5,GroupName="12. Webhooks")] public bool ProjectXTradeAllAccounts {get;set;}
        ...
        [NinjaScriptProperty][Display(Name="ProjectX Contract ID",Description="Optional direct contract id override.",Order=9,GroupName="12. Webhooks")] public string ProjectXContractId {get;set;}
        ...
        [NinjaScriptProperty][Display(Name="Enable Price Offset Trail",Order=15,GroupName="0. Global")] public bool GlobalEnablePriceOffsetTrail {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="1b. NY-A Long")] public double NyALongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="1b. NY-A Long")] public double NyALongAdxPeakDrawdown {get;set;}
        // NY-A Short
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="1c. NY-A Short")] public double NyAShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="1c. NY-A Short")] public double NyAShortAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="2b. NY-B Long")] public double NyBLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="2b. NY-B Long")] public double NyBLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="2c. NY-B Short")] public double NyBShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="2c. NY-B Short")] public double NyBShortAdxPeakDrawdown {get;set;}
        // ── NY-C ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="3b. NY-C Long")] public double NyCLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="3b. NY-C Long")] public double NyCLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="3c. NY-C Short")] public double NyCShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="3c. NY-C Short")] public double NyCShortAdxPeakDrawdown {get;set;}
        // ── EU-A ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="4b. EU-A Long")] public double EuALongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="4b. EU-A Long")] public double EuALongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="4c. EU-A Short")] public double EuAShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="4c. EU-A Short")] public double EuAShortAdxPeakDrawdown {get;set;}
        // ── EU-B ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="5b. EU-B Long")] public double EuBLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="5b. EU-B Long")] public double EuBLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="5c. EU-B Short")] public double EuBShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="5c. EU-B Short")] public double EuBShortAdxPeakDrawdown {get;set;}
        // ── EU-C ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="6b. EU-C Long")] public double EuCLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="6b. EU-C Long")] public double EuCLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="6c. EU-C Short")] public double EuCShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="6c. EU-C Short")] public double EuCShortAdxPeakDrawdown {get;set;}
        // ── AS-A ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="7b. AS-A Long")] public double AsALongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="7b. AS-A Long")] public double AsALongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="7c. AS-A Short")] public double AsAShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="7c. AS-A Short")] public double AsAShortAdxPeakDrawdown {get;set;}
        // ── AS-B ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="8b. AS-B Long")] public double AsBLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="8b. AS-B Long")] public double AsBLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="8c. AS-B Short")] public double AsBShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="8c. AS-B Short")] public double AsBShortAdxPeakDrawdown {get;set;}
        // ── AS-C ────────────────────────────────────────────────────────────────
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="9b. AS-C Long")] public double AsCLongAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="9b. AS-C Long")] public double AsCLongAdxPeakDrawdown {get;set;}
        ...
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Max Level",Order=95,GroupName="9c. AS-C Short")] public double AsCShortAdxMaxLevel {get;set;}
        [NinjaScriptProperty][Range(0.0,100.0)][Display(Name="Adx Peak Drawdown",Order=96,GroupName="9c. AS-C Short")] public double AsCShortAdxPeakDrawdown {get;set;}
        #endregion
    }
