...
2026-12-30,14:00";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                L1_ConfirmationBars = 1;
                L1_EntryOffsetPercent = 9.25;
                L1_VarianceTicks = 0;
                L1_TPMode = TargetMode.PercentOfOR;
                L1_TakeProfitPercent = 99.365;
                L1_TakeProfitTicks = 120;
                L1_SLMode = TargetMode.PercentOfOR;
                L1_StopLossPercent = 141.6925;
                L1_StopLossTicks = 325;
                L1_MaxStopLossTicks = 248;
                L1_UseTrailingStop = false;
                ...
                L1_BreakevenTriggerPercent = 37;
                L1_BreakevenOffsetTicks = 11;
                L1_MaxBarsInTrade = 174;
                L1_MaxTradesPerDay = 4;
                L1_AtrTPThresholdTicks = 39;
                L1_AtrTPHighPercent = 47.515;
                ...
                L2_EntryOffsetPercent = 10.47;
                L2_VarianceTicks = 0;
                L2_TPMode = TargetMode.PercentOfOR;
                L2_TakeProfitPercent = 82.4675;
                L2_TakeProfitTicks = 331;
                L2_SLMode = TargetMode.PercentOfOR;
                L2_StopLossPercent = 102.4675;
                L2_StopLossTicks = 325;
                L2_MaxStopLossTicks = 387;
                L2_UseTrailingStop = true;
                L2_TrailStopPercent = 65.555;
                L2_TrailActivationPercent = 59.985;
                L2_TrailStepTicks = 0;
                ...
                L2_BreakevenOffsetTicks = 3;
                L2_MaxBarsInTrade = 122;
                L2_MaxTradesPerDay = 6;
                L2_AtrTPThresholdTicks = 35;
                L2_AtrTPHighPercent = 65.87;
                ...
                L3_ConfirmationBars = 3;
                L3_EntryOffsetPercent = 25.3425;
                L3_VarianceTicks = 0;
                L3_TPMode = TargetMode.PercentOfOR;
                L3_TakeProfitPercent = 42.695;
                L3_TakeProfitTicks = 331;
                L3_SLMode = TargetMode.PercentOfOR;
                L3_StopLossPercent = 53.105;
                L3_StopLossTicks = 325;
                L3_MaxStopLossTicks = 273;
                L3_UseTrailingStop = true;
                L3_TrailStopPercent = 18.85;
                L3_TrailActivationPercent = 13.655;
                L3_TrailStepTicks = 0;
                ...
                L3_BreakevenTriggerPercent = 17;
                L3_BreakevenOffsetTicks = 16;
                L3_MaxBarsInTrade = 178;
                L3_MaxTradesPerDay = 6;
                L3_AtrTPThresholdTicks = 75;
                L3_AtrTPHighPercent = 56.1275;
                ...
                L4_EntryOffsetPercent = 14.6925;
                L4_VarianceTicks = 0;
                L4_TPMode = TargetMode.PercentOfOR;
                L4_TakeProfitPercent = 140.875;
                L4_TakeProfitTicks = 331;
                L4_SLMode = TargetMode.PercentOfOR;
                L4_StopLossPercent = 40.8425;
                L4_StopLossTicks = 325;
                L4_MaxStopLossTicks = 345;
                L4_UseTrailingStop = true;
                L4_TrailStopPercent = 39.45;
                L4_TrailActivationPercent = 36.4;
                L4_TrailStepTicks = 0;
                ...
                L4_BreakevenTriggerPercent = 40;
                L4_BreakevenOffsetTicks = 35;
                L4_MaxBarsInTrade = 215;
                L4_MaxTradesPerDay = 2;
                L4_AtrTPThresholdTicks = 21;
                L4_AtrTPHighPercent = 151.875;
                ...
                S1_ConfirmationBars = 7;
                S1_EntryOffsetPercent = 25.72;
                S1_VarianceTicks = 0;
                S1_TPMode = TargetMode.PercentOfOR;
                S1_TakeProfitPercent = 226.4725;
                S1_TakeProfitTicks = 268;
                S1_SLMode = TargetMode.PercentOfOR;
                S1_StopLossPercent = 138.235;
                S1_StopLossTicks = 145;
                S1_MaxStopLossTicks = 297;
                S1_UseTrailingStop = true;
                S1_TrailStopPercent = 36.0875;
                S1_TrailActivationPercent = 73.6975;
                S1_TrailStepTicks = 0;
                ...
                S1_BreakevenTriggerPercent = 48;
                S1_BreakevenOffsetTicks = 4;
                S1_MaxBarsInTrade = 66;
                S1_MaxTradesPerDay = 6;
                S1_AtrTPThresholdTicks = 11;
                S1_AtrTPHighPercent = 188.5975;
                ...
                S2_EntryOffsetPercent = 26.08;
                S2_VarianceTicks = 0;
                S2_TPMode = TargetMode.PercentOfOR;
                S2_TakeProfitPercent = 209.39;
                S2_TakeProfitTicks = 268;
                S2_SLMode = TargetMode.PercentOfOR;
                S2_StopLossPercent = 50.77;
                S2_StopLossTicks = 145;
                S2_MaxStopLossTicks = 355;
                S2_UseTrailingStop = true;
                S2_TrailStopPercent = 41.55;
                S2_TrailActivationPercent = 30.2;
                S2_TrailStepTicks = 0;
                ...
                S2_BreakevenTriggerPercent = 22;
                S2_BreakevenOffsetTicks = 19;
                S2_MaxBarsInTrade = 105;
                S2_MaxTradesPerDay = 4;
                S2_AtrTPThresholdTicks = 46;
                S2_AtrTPHighPercent = 116.1375;
                ...
                S3_EntryOffsetPercent = 15.88;
                S3_VarianceTicks = 0;
                S3_TPMode = TargetMode.PercentOfOR;
                S3_TakeProfitPercent = 112.045;
                S3_TakeProfitTicks = 268;
                S3_SLMode = TargetMode.PercentOfOR;
                S3_StopLossPercent = 97.385;
                S3_StopLossTicks = 145;
                S3_MaxStopLossTicks = 416;
                S3_UseTrailingStop = true;
                S3_TrailStopPercent = 20.9;
                S3_TrailActivationPercent = 38.15;
                S3_TrailStepTicks = 0;
                ...
                S3_BreakevenTriggerPercent = 37;
                S3_BreakevenOffsetTicks = 48;
                S3_MaxBarsInTrade = 164;
                S3_MaxTradesPerDay = 2;
                S3_AtrTPThresholdTicks = 84;
                S3_AtrTPHighPercent = 65.17;
                ...
                S4_EntryOffsetPercent = 10.28;
                S4_VarianceTicks = 0;
                S4_TPMode = TargetMode.PercentOfOR;
                S4_TakeProfitPercent = 93.5125;
                S4_TakeProfitTicks = 268;
                S4_SLMode = TargetMode.PercentOfOR;
                S4_StopLossPercent = 50.6225;
                S4_StopLossTicks = 145;
                S4_MaxStopLossTicks = 481;
                S4_UseTrailingStop = true;
                S4_TrailStopPercent = 28.26;
                S4_TrailActivationPercent = 4.9;
                S4_TrailStepTicks = 0;
                ...
                S4_BreakevenTriggerPercent = 26;
                S4_BreakevenOffsetTicks = 22;
                S4_MaxBarsInTrade = 59;
                S4_MaxTradesPerDay = 2;
                S4_AtrTPThresholdTicks = 103;
                S4_AtrTPHighPercent = 43.6575;
        ...
        [NinjaScriptProperty]
        [Display(Name = "ProjectX API Base URL", Description = "ProjectX gateway base URL. Leave the default ProjectX gateway URL or paste your firm-specific endpoint.", GroupName = "O. Webhooks", Order = 2)]
        public string ProjectXApiBaseUrl { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "ProjectX Username", Description = "ProjectX login username for direct ProjectX order routing.", GroupName = "O. Webhooks", Order = 3)]
        public string ProjectXUsername { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "ProjectX API Key", Description = "ProjectX API key used together with the ProjectX username.", GroupName = "O. Webhooks", Order = 4)]
        public string ProjectXApiKey { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "ProjectX Accounts", Description = "Comma-separated ProjectX account ids or exact account names.", GroupName = "O. Webhooks", Order = 5)]
        public string ProjectXAccountId { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "ProjectX Contract ID", Description = "Optional override for support/debug use only.", GroupName = "O. Webhooks", Order = 6)]
