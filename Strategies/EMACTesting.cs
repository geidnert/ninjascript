    ...
    public class EMACTesting : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                PreviousCandleOffsetPoints = 1.0;
                PivotStrength = 2;
                PivotOffsetPoints = 1.0;
                SlopeTargetMultiplier = 2.0;
                CandleReversalExitBars = 8;
                CandleReversalCloseBeyondPoints = 1.75;
                CandleReversalMinBodyPoints = 0.5;
