...
2026-12-30,14:00";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                NewYorkAdxMaxThreshold = 56.56;
                NewYorkAdxMinSlopePoints = 1.71;
                NewYorkAdxPeakDrawdownExitUnits = 15.62;
                NewYorkAdxAbsoluteExitLevel = 69.3;
                NewYorkStopPaddingPoints = 13.5;
                NewYorkExitCrossPoints = 5.5;
                ...
                NewYork2AdxDdRiskModeTakeProfitPoints = 92.5;
