...
2026-12-30,14:00";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                AsiaStopPaddingPoints = 11.17;
                AsiaExitCrossPoints = 1.31;
                AsiaFlipEmaCrossPoints = 1.18;
                AsiaMaxStopLossPoints = 124;
                AsiaTakeProfitPoints = 118.2;
                AsiaAtrMinimum = 11.7;
                AsiaEnableFlipBreakEven = true;
                AsiaFlipBreakEvenTriggerPoints = 8.3;
                AsiaFlipTakeProfitPoints = 53.7;
                AsiaTakeProfitPercentTriggerPercent = 53.1;
                AsiaTakeProfitPercentStopMovePercent = 17.61;
                AsiaRequireMinAdxForFlips = true;
                AsiaEnableAdxDdRiskMode = true;
                AsiaAdxDdRiskModeStopLossPoints = 7.16;
                ...
                Asia2StopPaddingPoints = 50.79;
                Asia2ExitCrossPoints = 5.65;
                Asia2FlipEmaCrossPoints = 1.18;
                Asia2MaxStopLossPoints = 209.9;
                Asia2TakeProfitPoints = 80.3;
                Asia2AtrMinimum = 5.1;
                Asia2EnableFlipBreakEven = true;
                Asia2FlipBreakEvenTriggerPoints = 24.2;
                Asia2FlipTakeProfitPoints = 109.7;
                Asia2TakeProfitPercentTriggerPercent = 72.61;
                Asia2TakeProfitPercentStopMovePercent = 69.25;
                Asia2RequireMinAdxForFlips = true;
                Asia2EnableAdxDdRiskMode = true;
                Asia2AdxDdRiskModeStopLossPoints = 11.64;
                Asia2AdxDdRiskModeTakeProfitPoints = 44.74;
                ...
                Asia3StopPaddingPoints = 5.51;
                Asia3ExitCrossPoints = 1.56;
                Asia3FlipEmaCrossPoints = 1.18;
                Asia3MaxStopLossPoints = 150.1;
                Asia3TakeProfitPoints = 98;
                Asia3AtrMinimum = 4;
                Asia3EnableFlipBreakEven = false;
                Asia3FlipBreakEvenTriggerPoints = 0.1;
                Asia3FlipTakeProfitPoints = 88.8;
                Asia3TakeProfitPercentTriggerPercent = 67.85;
                Asia3TakeProfitPercentStopMovePercent = 75.3;
                Asia3RequireMinAdxForFlips = true;
                Asia3EnableAdxDdRiskMode = false;
                Asia3AdxDdRiskModeStopLossPoints = 2.34;
                Asia3AdxDdRiskModeTakeProfitPoints = 36.26;
                ...
                LondonFlipEmaCrossPoints = 1.18;
                LondonMaxStopLossPoints = 123.2;
                ...
                LondonTakeProfitPercentTriggerPercent = 66.54;
                LondonTakeProfitPercentStopMovePercent = 36.23;
                ...
                London2StopPaddingPoints = 12.19;
                London2ExitCrossPoints = 2.6;
                London2FlipEmaCrossPoints = 5.57;
                London2MaxStopLossPoints = 116.8;
                London2TakeProfitPoints = 134.6;
                London2AtrMinimum = 7.8;
                London2EnableFlipBreakEven = true;
                London2FlipBreakEvenTriggerPoints = 8.8;
                London2FlipTakeProfitPoints = 112.2;
                London2TakeProfitPercentTriggerPercent = 46.55;
                ...
                London2AdxDdRiskModeTakeProfitPoints = 47.34;
                ...
                London3StopPaddingPoints = 13.69;
                London3ExitCrossPoints = 6.71;
                London3FlipEmaCrossPoints = 1.37;
                London3MaxStopLossPoints = 124.8;
                London3TakeProfitPoints = 112.5;
                London3AtrMinimum = 8;
                London3EnableFlipBreakEven = true;
                London3FlipBreakEvenTriggerPoints = 12.3;
                London3FlipTakeProfitPoints = 97.4;
                London3TakeProfitPercentTriggerPercent = 33.71;
                London3TakeProfitPercentStopMovePercent = 59.98;
                London3RequireMinAdxForFlips = true;
                London3EnableAdxDdRiskMode = true;
                London3AdxDdRiskModeStopLossPoints = 4.68;
                ...
                NewYorkStopPaddingPoints = 39.97;
                NewYorkExitCrossPoints = 5.22;
                NewYorkFlipEmaCrossPoints = 2.34;
                NewYorkMaxStopLossPoints = 253.7;
                NewYorkTakeProfitPoints = 170.4;
                NewYorkAtrMinimum = 9.8;
                NewYorkEnableFlipBreakEven = true;
                NewYorkFlipBreakEvenTriggerPoints = 20.9;
                NewYorkFlipTakeProfitPoints = 94.4;
                NewYorkTakeProfitPercentTriggerPercent = 75.81;
                NewYorkTakeProfitPercentStopMovePercent = 83.12;
                NewYorkRequireMinAdxForFlips = true;
                NewYorkEnableAdxDdRiskMode = true;
                NewYorkAdxDdRiskModeStopLossPoints = 16.22;
                ...
                NewYork2Contracts = 1;
                NewYork2FlipAdxThreshold = 14.9;
                NewYork2EmaMinSlopePointsPerBar = 0;
                NewYork2AdxPeriod = 14;
                NewYork2AdxThreshold = 22.6;
                NewYork2AdxMaxThreshold = 39.58;
                NewYork2AdxMinSlopePoints = 1.56;
                NewYork2AdxPeakDrawdownExitUnits = 6.61;
                NewYork2AdxAbsoluteExitLevel = 47.8;
                NewYork2StopPaddingPoints = 16.66;
                NewYork2ExitCrossPoints = 10.96;
                NewYork2FlipEmaCrossPoints = 1.18;
                NewYork2MaxStopLossPoints = 167.2;
                NewYork2TakeProfitPoints = 195.1;
                NewYork2AtrMinimum = 17;
                NewYork2EnableFlipBreakEven = true;
                NewYork2FlipBreakEvenTriggerPoints = 19.6;
                NewYork2FlipTakeProfitPoints = 29.8;
                NewYork2TakeProfitPercentTriggerPercent = 65.17;
                NewYork2TakeProfitPercentStopMovePercent = 59.09;
                ...
                NewYork3Contracts = 1;
                NewYork3FlipAdxThreshold = 7.5;
                NewYork3EmaMinSlopePointsPerBar = 0;
                NewYork3AdxPeriod = 14;
                NewYork3AdxThreshold = 19;
                NewYork3AdxMaxThreshold = 32.69;
                NewYork3AdxMinSlopePoints = 1.48;
                NewYork3AdxPeakDrawdownExitUnits = 4.64;
                NewYork3AdxAbsoluteExitLevel = 47.8;
                NewYork3StopPaddingPoints = 35.15;
                NewYork3ExitCrossPoints = 10.25;
                NewYork3FlipEmaCrossPoints = 1.18;
                NewYork3MaxStopLossPoints = 98.1;
                NewYork3TakeProfitPoints = 99.5;
                NewYork3AtrMinimum = 0;
                NewYork3EnableFlipBreakEven = true;
                NewYork3FlipBreakEvenTriggerPoints = 9.4;
                NewYork3FlipTakeProfitPoints = 85.4;
                ...
                NewYork3AdxDdRiskModeStopLossPoints = 8.25;
