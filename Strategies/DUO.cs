...
2026-12-30,14:00";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                AsiaAdxPeriod = 14;
                AsiaAdxThreshold = 29.6;
                AsiaAdxMaxThreshold = 49.86;
                AsiaAdxMinSlopePoints = 0.9;
                AsiaAdxPeakDrawdownExitUnits = 8.24;
                AsiaAdxAbsoluteExitLevel = 61.2;
                AsiaStopPaddingPoints = 9.5;
                AsiaExitCrossPoints = 1.6;
                AsiaFlipEmaCrossPoints = 1;
                AsiaMaxStopLossPoints = 123;
                AsiaTakeProfitPoints = 118;
                AsiaAtrMinimum = 11.7;
                AsiaEnableFlipBreakEven = true;
                AsiaFlipBreakEvenTriggerPoints = 6.7;
                AsiaFlipTakeProfitPoints = 45.7;
                AsiaTakeProfitPercentTriggerPercent = 61.38;
                AsiaTakeProfitPercentStopMovePercent = 21;
                AsiaRequireMinAdxForFlips = true;
                AsiaEnableAdxDdRiskMode = true;
                AsiaAdxDdRiskModeStopLossPoints = 6.1;
                AsiaAdxDdRiskModeTakeProfitPoints = 75.83;
                ...
                Asia2AdxMaxThreshold = 39.47;
                Asia2AdxMinSlopePoints = 1.14;
                Asia2AdxPeakDrawdownExitUnits = 14.65;
                Asia2AdxAbsoluteExitLevel = 62.9;
                Asia2StopPaddingPoints = 50.8;
                Asia2ExitCrossPoints = 5.7;
                Asia2FlipEmaCrossPoints = 1;
                Asia2MaxStopLossPoints = 210;
                Asia2TakeProfitPoints = 80;
                Asia2AtrMinimum = 5.1;
                Asia2EnableFlipBreakEven = true;
                Asia2FlipBreakEvenTriggerPoints = 21;
                Asia2FlipTakeProfitPoints = 111.9;
                ...
                Asia3AdxPeriod = 14;
                Asia3AdxThreshold = 40.2;
                Asia3AdxMaxThreshold = 55.39;
                Asia3AdxMinSlopePoints = 1.3;
                Asia3AdxPeakDrawdownExitUnits = 13.94;
                Asia3AdxAbsoluteExitLevel = 62.9;
                Asia3StopPaddingPoints = 4.7;
                Asia3ExitCrossPoints = 1.6;
                Asia3FlipEmaCrossPoints = 1;
                Asia3MaxStopLossPoints = 149;
                Asia3TakeProfitPoints = 98;
                Asia3AtrMinimum = 4;
                Asia3EnableFlipBreakEven = true;
                Asia3FlipBreakEvenTriggerPoints = 0.1;
                ...
                Asia3AdxDdRiskModeStopLossPoints = 2.02;
                Asia3AdxDdRiskModeTakeProfitPoints = 30.88;
                ...
                LondonAdxMinSlopePoints = 0.89;
                LondonAdxPeakDrawdownExitUnits = 12.48;
                LondonAdxAbsoluteExitLevel = 50.6;
                LondonStopPaddingPoints = 29.6;
                LondonExitCrossPoints = 17.3;
                ...
                LondonTakeProfitPercentTriggerPercent = 75;
                LondonTakeProfitPercentStopMovePercent = 34;
                LondonRequireMinAdxForFlips = true;
                LondonEnableAdxDdRiskMode = true;
                LondonAdxDdRiskModeStopLossPoints = 6.56;
                LondonAdxDdRiskModeTakeProfitPoints = 39.49;
                ...
                London2EmaPeriod = 21;
                London2Contracts = 1;
                London2FlipAdxThreshold = 14.5;
                London2AdxPeriod = 14;
                London2AdxThreshold = 13.4;
                London2AdxMaxThreshold = 28.93;
                London2AdxMinSlopePoints = 0.94;
                London2AdxPeakDrawdownExitUnits = 10.81;
                London2AdxAbsoluteExitLevel = 52.2;
                London2StopPaddingPoints = 10.3;
                London2ExitCrossPoints = 2.6;
                London2FlipEmaCrossPoints = 5.5;
                London2MaxStopLossPoints = 115;
                London2TakeProfitPoints = 135;
                London2AtrMinimum = 7.8;
                London2EnableFlipBreakEven = true;
                London2FlipBreakEvenTriggerPoints = 7.2;
                London2FlipTakeProfitPoints = 112.2;
                ...
                London2AdxDdRiskModeTakeProfitPoints = 41.13;
                ...
                London3AdxAbsoluteExitLevel = 49.7;
                London3StopPaddingPoints = 13.7;
                London3ExitCrossPoints = 6.7;
                London3FlipEmaCrossPoints = 1.25;
                London3MaxStopLossPoints = 125;
                London3TakeProfitPoints = 112;
                London3AtrMinimum = 8;
                London3EnableFlipBreakEven = true;
                London3FlipBreakEvenTriggerPoints = 10.8;
                London3FlipTakeProfitPoints = 83.7;
                London3TakeProfitPercentTriggerPercent = 62;
                London3TakeProfitPercentStopMovePercent = 17.09;
                London3RequireMinAdxForFlips = true;
                London3EnableAdxDdRiskMode = true;
                London3AdxDdRiskModeStopLossPoints = 4.04;
                London3AdxDdRiskModeTakeProfitPoints = 51.82;
                ...
                NewYorkEmaPeriod = 16;
                NewYorkContracts = 1;
                NewYorkFlipAdxThreshold = 8;
                NewYorkAdxPeriod = 14;
                NewYorkAdxThreshold = 32.4;
                NewYorkAdxMaxThreshold = 51.42;
                NewYorkAdxMinSlopePoints = 1.63;
                NewYorkAdxPeakDrawdownExitUnits = 14.88;
                NewYorkAdxAbsoluteExitLevel = 69.3;
                NewYorkStopPaddingPoints = 31.5;
                NewYorkExitCrossPoints = 5.3;
                NewYorkFlipEmaCrossPoints = 2;
                NewYorkMaxStopLossPoints = 248;
                NewYorkTakeProfitPoints = 170;
                NewYorkAtrMinimum = 9.8;
                NewYorkEnableFlipBreakEven = true;
                NewYorkFlipBreakEvenTriggerPoints = 18;
                NewYorkFlipTakeProfitPoints = 81.7;
                ...
                NewYorkAdxDdRiskModeStopLossPoints = 13.6;
                NewYorkAdxDdRiskModeTakeProfitPoints = 142.45;
                ...
                NewYork2Contracts = 1;
                NewYork2FlipAdxThreshold = 13.4;
                NewYork2AdxPeriod = 14;
                NewYork2AdxThreshold = 22.7;
                NewYork2AdxMaxThreshold = 39.78;
                NewYork2AdxMinSlopePoints = 1.58;
                NewYork2AdxPeakDrawdownExitUnits = 6.64;
                NewYork2AdxAbsoluteExitLevel = 46.8;
                NewYork2StopPaddingPoints = 16.1;
                NewYork2ExitCrossPoints = 11;
                NewYork2FlipEmaCrossPoints = 1;
                NewYork2MaxStopLossPoints = 167;
                NewYork2TakeProfitPoints = 195;
                NewYork2AtrMinimum = 17;
                NewYork2EnableFlipBreakEven = true;
                NewYork2FlipBreakEvenTriggerPoints = 16.6;
                NewYork2FlipTakeProfitPoints = 25.3;
                NewYork2TakeProfitPercentTriggerPercent = 59;
                NewYork2TakeProfitPercentStopMovePercent = 11.22;
                NewYork2RequireMinAdxForFlips = true;
                NewYork2EnableAdxDdRiskMode = true;
                NewYork2AdxDdRiskModeStopLossPoints = 48.53;
                NewYork2AdxDdRiskModeTakeProfitPoints = 73.44;
                ...
                NewYork3StopPaddingPoints = 29.9;
                NewYork3ExitCrossPoints = 8.7;
                ...
                NewYork3FlipBreakEvenTriggerPoints = 7.9;
                NewYork3FlipTakeProfitPoints = 73.5;
                NewYork3TakeProfitPercentTriggerPercent = 59;
                NewYork3TakeProfitPercentStopMovePercent = 33.16;
                NewYork3RequireMinAdxForFlips = true;
                NewYork3EnableAdxDdRiskMode = true;
                NewYork3AdxDdRiskModeStopLossPoints = 7.1;
