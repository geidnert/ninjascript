...
2026-12-30,14:00";
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                AsiaStopPaddingPoints = 10.2;
                AsiaExitCrossPoints = 1.31;
                AsiaFlipEmaCrossPoints = 1.09;
                AsiaMaxStopLossPoints = 123.4;
                AsiaTakeProfitPoints = 118.2;
                AsiaAtrMinimum = 11.7;
                AsiaEnableFlipBreakEven = true;
                AsiaFlipBreakEvenTriggerPoints = 7.4;
                AsiaFlipTakeProfitPoints = 49.2;
                AsiaTakeProfitPercentTriggerPercent = 48.51;
                AsiaTakeProfitPercentStopMovePercent = 16.09;
                AsiaRequireMinAdxForFlips = true;
                AsiaEnableAdxDdRiskMode = true;
                AsiaAdxDdRiskModeStopLossPoints = 6.53;
                ...
                London2AdxDdRiskModeTakeProfitPoints = 43.25;
                ...
                NewYorkStopPaddingPoints = 36.51;
                NewYorkExitCrossPoints = 5.22;
                NewYorkFlipEmaCrossPoints = 2.16;
                NewYorkMaxStopLossPoints = 249.9;
                NewYorkTakeProfitPoints = 170.4;
                NewYorkAtrMinimum = 9.8;
                NewYorkEnableFlipBreakEven = true;
                NewYorkFlipBreakEvenTriggerPoints = 19.1;
                NewYorkFlipTakeProfitPoints = 86.3;
                NewYorkTakeProfitPercentTriggerPercent = 69.25;
                NewYorkTakeProfitPercentStopMovePercent = 83.12;
                NewYorkRequireMinAdxForFlips = true;
                NewYorkEnableAdxDdRiskMode = true;
                NewYorkAdxDdRiskModeStopLossPoints = 14.82;
                ...
                NewYork3AdxPeakDrawdownExitUnits = 4.25;
                NewYork3AdxAbsoluteExitLevel = 47.8;
                NewYork3StopPaddingPoints = 32.12;
                NewYork3ExitCrossPoints = 9.36;
                NewYork3FlipEmaCrossPoints = 1.09;
                NewYork3MaxStopLossPoints = 95.1;
