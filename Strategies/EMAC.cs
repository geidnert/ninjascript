...
{
    public class EMAC : Strategy
    {
        private const string StrategySignalPrefix = "EMAC";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "EMAC strategy: EMA slope, close through the EMA, then moving limit at the EMA line.";
                Name = "EMAC";
                ...
                Contracts = 1;
                StopLossPoints = 4.0;
                TakeProfitType = EMAC_TakeProfitType.FixedPoints;
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (longSetupActive && EntryEmaSlopePasses(true, emaSlopePoints))
                SubmitOrUpdateLimit(true, emaValue, emaSlopePoints);
            else if (shortSetupActive && EntryEmaSlopePasses(false, emaSlopePoints))
        ...
        private void SubmitOrUpdateLimit(bool isLong, double emaValue, double emaSlopePoints)
        {
            ...
            if (TakeProfitType != EMAC_TakeProfitType.None)
        ...
        [NinjaScriptProperty]
        [Display(Name = "Limit Offset Points", Description = "Signed EMA offset. -1 means 1 point below EMA for longs and 1 point above EMA for shorts.", GroupName = "Parameters", Order = 2)]
        public double LimitOffsetPoints { get; set; }

        [Range(1, int.MaxValue), NinjaScriptProperty]
        [Display(Name = "Contracts", Description = "Order quantity per entry.", GroupName = "Parameters", Order = 3)]
        public int Contracts { get; set; }

        [Range(0.01, double.MaxValue), NinjaScriptProperty]
        [Display(Name = "Stop Loss Points", Description = "Fixed stop distance from the limit entry.", GroupName = "Parameters", Order = 4)]
        ...
        public EMAC_TakeProfitType TakeProfitType { get; set; }
    ...
    public enum EMAC_TakeProfitType
    {
        None,
        FixedPoints,
        PreviousCandle,
